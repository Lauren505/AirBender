...
if __name__=='__main__':
	...
	parser.add_argument('-i', '--incident_angle', type=int, nargs=1, default=[UNDEFINED])
	...
	# Code for setting custom incident angle
	if not args.incident_angle[0] < 0:
		# if abs(incident_angles[args.incident_angle[0]] - uservo.query_servo_angle(SERVO_2_ID)) > 2.0: TODO REMOVE ??
	...
	for line in f:
		...
		targets.append((sample[0], int(sample[2])))
